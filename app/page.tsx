              ...
              <section className="py-2 mt-28" id='news-section'>
                  <Container className='gap-7 lg:gap-5 flex flex-col justify-center items-center'>
                      ...
                      <div className='w-full py-2 grid grid-cols-1 lg:grid-cols-3 gap-10'>
                          <div
                              className='h-72 rounded-2xl bg-[url("https://images.unsplash.com/photo-1491036775913-3fbc5c455842")] bg-cover'></div>
                          <div
                              className='h-72 rounded-2xl bg-[url("https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e")] bg-cover'></div>
                          <div
                              className='h-72 rounded-2xl bg-[url("https://images.unsplash.com/photo-1553432172-f37667f5ed15")] bg-cover'></div>
                      </div>
                      <button
                          className='font-roboto transition-all ease-in-out duration-300 border border-black rounded-full py-1 px-2 hover:bg-zinc-800 hover:text-white'>
                          show all news
