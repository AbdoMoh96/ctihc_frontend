...
const Footer: React.FC<propTypes> = async () => {
    ...
    const { contactUs, settings } = await getData('en');
            ...
            <Container className='gap-7 lg:gap-5 flex flex-col justify-center items-center '>
                <div className='w-full py-2 grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 gap-16'>
                    ...
                    <div className='py-2 flex flex-col items-center lg:items-start text-xl lg:text-base'>
                        <h1 className='font-roboto rtl:font-cairo mb-2 font-semibold text-white capitalize'>__translate_browse</h1>
                        <div className='flex flex-col font-roboto rtl:font-cairo text-gray-400 items-center gap-2 lg:items-start'>
                            <Link className='transition-all duration-500 ease-in-out hover:text-amber-500 w-fit'
                                  href='#'>__translate_home</Link>
                            <Link className='transition-all duration-500 ease-in-out hover:text-amber-500 w-fit'
                                  href='#'>__translate_about_us</Link>
                            <Link className='transition-all duration-500 ease-in-out hover:text-amber-500 w-fit'
                                  href='#'>__translate_reports</Link>
                            <Link className='transition-all duration-500 ease-in-out hover:text-amber-500 w-fit'
                                  href='#'>__translate_group_structure</Link>
                            <Link className='transition-all duration-500 ease-in-out hover:text-amber-500 w-fit'
                                  href='#'>__translate_news</Link>
                            <Link className='transition-all duration-500 ease-in-out hover:text-amber-500 w-fit'
                                  href='#'>__translate_contact_us</Link>
                        </div>
                    </div>
                    <div className='py-2 flex flex-col items-center lg:items-start text-xl lg:text-base'>
                        <h1 className='font-roboto rtl:font-cairo mb-2 font-semibold text-white capitalize'>__translate_follow_us_on</h1>
                        <div className='flex flex-col font-roboto rtl:font-cairo text-gray-400 items-center gap-2 lg:items-start'>
                            {
                    ...
                    <div className='py-2 flex flex-col items-center lg:items-start text-xl lg:text-base'>
                        <h1 className='font-roboto rtl:font-cairo mb-2 font-semibold text-white capitalize'>__translate_contact_us</h1>
                        <div className='flex flex-col font-roboto rtl:font-cairo text-gray-400 items-center gap-2 lg:items-start'>
                            <Link className='transition-all capitalize flex items-center gap-1 duration-500 ease-in-out hover:text-amber-500 w-fit'
