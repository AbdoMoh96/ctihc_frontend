...
const NewsSection : React.FC<propTypes> = async () => {

    const news = await getData('en');
    ...
    return <AnimatedSection className="py-2 mt-28" id='news-section'>
        <Container className='gap-7 lg:gap-5 flex flex-col justify-center items-center'>
            <h1 className='text-3xl font-roboto rtl:font-cairo font-semibold text-center'>__translate_news_title</h1>
